...
public class PRectangle extends AbstractGeRuDok{

	
	public PRectangle() {
		putValue(ACCELERATOR_KEY, KeyStroke.getKeyStroke(
		        KeyEvent.VK_L, ActionEvent.CTRL_MASK));
		putValue(SMALL_ICON, loadIcon("gui_icons/rectangle_icon.png"));
		putValue(NAME, "Rectangle");
		putValue(SHORT_DESCRIPTION, "Draw a rectangle");
